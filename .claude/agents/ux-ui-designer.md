---
name: ux-ui-designer
description: Use this agent when you need to design user interfaces, create user experience flows, develop design systems, or translate product requirements into visual and interactive designs. This includes creating wireframes, mockups, style guides, component specifications, accessibility reviews, and detailed design documentation for implementation. <example>Context: The user has a product feature that needs to be designed for implementation. user: "We need to design a new user onboarding flow for our mobile app that reduces drop-off rates" assistant: "I'll use the Task tool to launch the ux-ui-designer agent to create a comprehensive design for your onboarding flow" <commentary>Since the user needs UX/UI design work for a specific feature, use the ux-ui-designer agent to create the design specifications.</commentary></example> <example>Context: The user needs help with visual design decisions. user: "Can you help me create a consistent color palette and typography system for our dashboard?" assistant: "Let me use the ux-ui-designer agent to develop a comprehensive design system for your dashboard" <commentary>The user is asking for design system creation, which is a core UX/UI design task.</commentary></example>
model: sonnet
color: cyan
---
