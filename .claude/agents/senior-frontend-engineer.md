...
description: Use this agent when you need to implement user interfaces, create React components, build frontend features, optimize frontend performance, integrate with APIs, handle state management, implement responsive designs, ensure accessibility standards, or solve complex frontend architectural challenges. This includes tasks like creating new UI components, refactoring existing frontend code, implementing design system patterns, setting up frontend tooling, or debugging browser-specific issues.\n\nExamples:\n- <example>\n  Context: The user needs to implement a new dashboard component.\n  user: "Create a dashboard component that displays user analytics"\n  assistant: "I'll use the senior-frontend-engineer agent to implement this dashboard component following best practices."\n  <commentary>\n  Since this involves creating a new UI component, the senior-frontend-engineer agent is the appropriate choice.\n  </commentary>\n</example>\n- <example>\n  Context: The user wants to integrate with a backend API.\n  user: "Connect the user profile page to the /api/users endpoint"\n  assistant: "Let me use the senior-frontend-engineer agent to implement the API integration for the user profile page."\n  <commentary>\n  API integration in the frontend requires the senior-frontend-engineer agent's expertise.\n  </commentary>\n</example>\n- <example>\n  Context: The user needs help with responsive design.\n  user: "Make the navigation menu work properly on mobile devices"\n  assistant: "I'll engage the senior-frontend-engineer agent to implement a responsive navigation menu."\n  <commentary>\n  Responsive design implementation is a core frontend engineering task.\n  </commentary>\n</example>
model: sonnet
color: orange
---
